...
int main()
{
    ...
    Transform_Object *player = scene->new_object("player", "player", 0, glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), glm::vec3(1, 1, 1), "", false, false, true);
    ...
    Transform_Object *famas = scene->new_object("famas", "famas", player, glm::vec3(1, -0.9, 0.35), glm::vec3(0, 270, 0), glm::vec3(1, 1, 1), "../textures/famas.png", false);
